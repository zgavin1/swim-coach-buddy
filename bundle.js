...
/***/ function(module, exports, __webpack_require__) {
	...
	var stopWatch = function stopWatch() {
	  var state = arguments.length <= 0 || arguments[0] === undefined ? defaultWatchState : arguments[0];
	  var action = arguments[1];
	...
	var StopWatchDisplay = function StopWatchDisplay(_ref2) {
	  ...
	  var displayTime = moment(time).format("mm:ss.SS");
	...
	var SetList = function SetList(_ref4) {
	  var sets = _ref4.sets;
	  var onSetClick = _ref4.onSetClick;
	  return React.createElement(
	    'ul',
	    null,
	    sets.reverse().map(function (set) {
	      return React.createElement(Set, _extends({
	        key: set.id
	      }, set, {
	        onClick: function onClick() {
	...
	var AddSet = function AddSet(_ref5) {
	...
	var SetApp = function SetApp() {
	  return React.createElement(
	    'div',
	    null,
	    React.createElement(AddSets, null),
	    React.createElement(VisibleSetList, null),
	...
	ReactDOM.render(React.createElement(
	  Provider,
	  { store: createStore(setApp) },
	  React.createElement(SetApp, null)
